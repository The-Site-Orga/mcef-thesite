...
public class ScreenCfg extends Screen {
    ...
    @Override
    public void render(GuiGraphics graphics, int i1, int i2, float f) {
        RenderSystem.disableDepthTest();
        RenderSystem.enableBlend();
        browser.draw(graphics, unscaleX(x), unscaleY(height + y), unscaleX(width + x), unscaleY(y));
        ...
        if(drawSquare) {
            ...
            vb.vertex(matrix, (float) unscaleX(x + width), (float) unscaleY(y + height), 0.0f).color(255, 255, 255, 255).endVertex();
            vb.vertex(matrix, (float) unscaleX(x + width + 10), (float) unscaleY(y + height), 0.0f).color(255, 255, 255, 255).endVertex();
            vb.vertex(matrix, (float) unscaleX(x + width + 10), (float) unscaleY(y + height + 10), 0.0f).color(255, 255, 255, 255).endVertex();
            vb.vertex(matrix, (float) unscaleX(x + width), (float) unscaleY(y + height + 10), 0.0f).color(255, 255, 255, 255).endVertex();
            t.end();
        }
